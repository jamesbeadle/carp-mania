...
<div class="mb-6 flex flex-wrap items-end gap-4">
	<div>
		...
		<h1 class="text-4xl text-gold-300">{data.water.lake.name}</h1>
	</div>
...
<div class="grid gap-6 lg:grid-cols-[3fr_2fr]">
	...
	<section class="panel">
		<h2 class="mb-3 text-xl text-gold-300">The water</h2>
...
<div class="mt-6 grid gap-6 lg:grid-cols-2">
	<section class="panel">
		<h2 class="mb-3 text-xl text-gold-300">The stock</h2>
		<StockTable carp={data.water.carp} limit={15} />
	</section>
	<section class="panel">
		<h2 class="mb-3 text-xl text-gold-300">Recent catches</h2>
