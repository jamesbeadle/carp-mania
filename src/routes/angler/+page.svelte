...
<h1 class="mb-6 text-4xl text-gold-300">{data.angler.profile.display_name}</h1>
...
<div class="grid gap-6 lg:grid-cols-[2fr_3fr]">
	<section class="panel">
		...
		<h2 class="mb-3 text-xl text-gold-300">Skills</h2>
	...
	<section class="panel">
		<h2 class="mb-3 text-xl text-gold-300">Catch history</h2>
