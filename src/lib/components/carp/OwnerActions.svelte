...
<section class="panel self-start">
	...
	{/if}
	<p class="mt-3 text-xs text-mist-400">The dealer pays {dealerSharePercent}% of guide on the spot for the first {DealerTerms.FullShareFishPerFisheryDay} fish a fishery day, and {bulkSharePercent}% after. Fish leave a water through the dealer only, so nobody can be paid by a second account.</p>
</section>
