...
<section class="panel mx-auto max-w-2xl">
	...
	<div class="mt-4">
		<AboutToggle title="About opening">Until the gates open {lake.name} is private: no anglers, no takings, no catches, nothing on the globe. Go public when you are ready and not before.</AboutToggle>
	</div>
</section>
