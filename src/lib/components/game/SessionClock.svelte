...
<span class="short:hidden hidden w-32 sm:block">
	...
	<span class="relative block h-1.5 overflow-hidden rounded-full bg-carbon-700">
		...
		<span class="relative block h-full bg-gradient-to-r from-volt-500 to-surge-500" style="width: {progress}%"></span>
	</span>
</span>
