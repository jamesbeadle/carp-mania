...
{#if short.length > 0}<p class="text-xs text-danger-400">Out of {short.join(', ')} — <a href="/market" class="underline">stock up at the counter</a> before you fish this rod.</p>{/if}
