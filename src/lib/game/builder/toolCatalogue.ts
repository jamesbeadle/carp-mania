...
export type BuilderTool = 'select' | 'island' | 'bar' | 'deepen' | 'dredge' | 'shelf' | 'reeds' | 'lilies' | 'snag' | 'swim' | 'shore' | 'extend' | 'land' | 'facility';
...
export const ToolCatalogue: Record<BuilderTool, ToolProfile> = {
	...
	bar: { label: 'Bar', hint: 'Click the water to lay out the bar; click the first point to close it.', kind: 'gravel_bar' },
	deepen: { label: 'Deepen', hint: 'Click the water to outline the hole; click the first point to close it.', kind: 'deepen' },
	dredge: { label: 'Dredge', hint: 'Click the water to outline the silt to shift; click the first point to close it.', kind: 'dredge' },
	shelf: { label: 'Shelf', hint: 'Click along the bank; double-click to finish the stretch.', kind: 'margin_shelf' },
	reeds: { label: 'Reeds', hint: 'Click along the bank; double-click to finish the stretch.', kind: 'reed_bed' },
	lilies: { label: 'Lilies', hint: 'Click shallow water to outline the pads; click the first point to close it.', kind: 'lily_pads' },
