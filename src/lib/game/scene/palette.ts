...
export const BankPalette = {
	...
	FacilityBadge: 'hsl(40 22% 92%)',
	FacilityBadgeEdge: 'hsla(28 40% 14% / 0.6)',
	FacilityGlyph: 'hsl(28 40% 18%)',
	FacilityLabel: 'hsl(40 22% 92%)',
	BoardFace: 'hsl(40 22% 94%)',
	BoardEdge: 'hsla(28 40% 14% / 0.7)',
	BoardInk: 'hsl(2 70% 40%)',
	BoardLeg: 'hsl(30 25% 28%)',
