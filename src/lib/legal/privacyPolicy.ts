...
export const PrivacyPolicy: LegalDocument = {
	...
	sections: [
		...
		},
		{
			...
			paragraphs: [
				`To run the game you asked for: signing you in, keeping your fishery going while you're away, showing your catches to the other players, and pinning a note on your noticeboard when something happens on your water. That is the contract between us.`,
		...
		},
		{
			...
			paragraphs: [
				`Carp Mania is a shared world. Other signed-in players can see your angler's name and picture, the waters you have opened to anglers and the fish in them, your catches, records and scrapbooks, and the events the world feed reports — a big fish, a sale, a new water, a retirement. Your email address is never shown to anyone.`,
