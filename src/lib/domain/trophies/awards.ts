export type AwardKey =
	...
	| 'five_regions' | 'ten_regions' | 'home_grown' | 'light_rod'
	| 'first_record' | 'three_waters' | 'ten_thousand_pounds'
	| 'night_owl' | 'early_bird' | 'the_full_book' | 'dealers_friend';
...
export const NoTallies: AwardTallies = {
	bestLb: 0, fishLanded: 0, regionsFished: 0, homeGrownBestLb: 0, lightRodBestLb: 0, recordsSet: 0,
	recordWaters: 0, lifetimeLb: 0, nightFish: 0, morningFish: 0, ticketKindsFished: 0, fishSold: 0
};
