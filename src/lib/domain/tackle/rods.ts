export type TestCurveLb = 2.75 | 3 | 3.5;
export type RodLengthFeet = 10 | 12 | 13;

export const RodLandsUpToLb: Record<TestCurveLb, number> = { 2.75: 35, 3: 50, 3.5: 100 };
export const RodLengthCastFactor: Record<RodLengthFeet, number> = { 10: 0.85, 12: 1, 13: 1.12 };
export const RodWords: Record<TestCurveLb, string> = { 2.75: 'The all-round carp rod', 3: 'For big fish and big waters', 3.5: 'Specialist — heavy, and you feel it on a twenty' };
