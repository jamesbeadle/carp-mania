...
import { runAnglerNameScenarios } from './testAnglerName';
import { runDiaryScenarios } from './testDiary';
import { runEstateScenarios } from './testEstate';
import { runFarmScenarios } from './testFarms';
...
import { runStockedToOpenScenarios } from './testStockedToOpen';
import { runStreakScenarios } from './testStreak';
import { runDesignEightScenarios } from './testDesignEight';
...
runRivalryScenarios();
runLightScenarios();
runDesignEightScenarios();
runStockedToOpenScenarios();
runAnglerNameScenarios();
