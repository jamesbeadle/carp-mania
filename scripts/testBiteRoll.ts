...
export function runBiteRollScenarios() {
	...
	const water: WaterToday = { lake, rating: DecentRating, watercraft: DecentWatercraft, season: seasonFor(lake, june), weather: weatherFor(lake, june), shoals: [], difficulty: EasyWater, recentCaptures: {}, nuisanceShare: 0, streakDays: 1 };
