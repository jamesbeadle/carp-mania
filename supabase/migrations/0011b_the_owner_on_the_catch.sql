...
begin
	...
	insert into public.catches (lake_id, carp_id, angler_id, angler_name, owner_name, weight_lb, swim_name, rig, bait, hook_size)
	values (lake, fish, angler, angler_name, owner_name, the_carp.weight_lb, swim_name, rig, bait, hook_size) returning id into catch_id;
