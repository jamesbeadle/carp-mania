drop function public.record_catch(uuid, uuid, uuid, text, text, text, integer, numeric, numeric, numeric, numeric);
...
begin
	...
	insert into public.catches (lake_id, carp_id, angler_id, angler_name, owner_name, fisherman_id, weight_lb, swim_name, rig, bait, hook_size, rod_item_id, reel_item_id)
	values (lake, fish, angler, angler_name, owner_name, fisherman, the_carp.weight_lb, swim_name, rig, bait, hook_size, rod_item, reel_item) returning id into catch_id;
...
revoke execute on function public.record_catch(uuid, uuid, uuid, text, text, text, integer, numeric, numeric, numeric, numeric, text, text, text) from public, anon, authenticated;
grant execute on function public.record_catch(uuid, uuid, uuid, text, text, text, integer, numeric, numeric, numeric, numeric, text, text, text) to service_role;
