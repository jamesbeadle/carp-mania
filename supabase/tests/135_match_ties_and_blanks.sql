...
reset role;
select public.record_catch(test.player(136), :'visit_a', :'bigger', 'Peg 1', 'hair rig', 'boilie', 6, 0, 0, 0, 0, 'bankside_basics-rod-2.75-12', 'bankside_basics-reel-carp_large', 'meadowmill-bait-shelf_life_boilie');
select public.record_catch(test.player(137), :'visit_b', :'smaller', 'Peg 2', 'hair rig', 'boilie', 6, 0, 0, 0, 0, 'bankside_basics-rod-2.75-12', 'bankside_basics-reel-carp_large', 'meadowmill-bait-shelf_life_boilie');
