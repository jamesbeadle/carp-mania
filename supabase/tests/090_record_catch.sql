...
select test.assert_refused(
	format('select public.record_catch(%L, %L, %L, %L, %L, %L, 6, 1, 1, 1, 1, %L, %L, %L)', test.player(91), :'visit', :'twenty', 'The Peg', 'hair rig', 'boilie', 'bankside_basics-rod-2.75-12', 'bankside_basics-reel-carp_large', 'meadowmill-bait-shelf_life_boilie'),
...
set role service_role;
select public.record_catch(test.player(91), :'visit', :'fifteen', 'The Peg', 'hair rig', 'boilie', 6, 0, 0, 0, 0, 'bankside_basics-rod-2.75-12', 'bankside_basics-reel-carp_large', 'meadowmill-bait-shelf_life_boilie');
select public.record_catch(test.player(91), :'visit', :'thirtytwo', 'The Peg', 'hair rig', 'boilie', 6, 0, 0, 0, 0, 'bankside_basics-rod-2.75-12', 'bankside_basics-reel-carp_large', 'meadowmill-bait-shelf_life_boilie');
select public.record_catch(test.player(91), :'visit', :'hidden', 'The Peg', 'hair rig', 'boilie', 6, 0, 0, 0, 0, 'bankside_basics-rod-2.75-12', 'bankside_basics-reel-carp_large', 'meadowmill-bait-shelf_life_boilie');
reset role;
...
set role service_role;
select public.record_catch(test.player(91), :'second_visit', :'thirtytwo', 'The Peg', 'hair rig', 'boilie', 6, 0, 0, 0, 0, 'bankside_basics-rod-2.75-12', 'bankside_basics-reel-carp_large', 'meadowmill-bait-shelf_life_boilie');
reset role;
