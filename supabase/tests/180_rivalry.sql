...
select public.record_catch(test.player(181), :'holder_visit', :'first', 'Peg 1', 'hair rig', 'boilie', 6, 2, 2, 2, 2);
select public.record_catch(test.player(182), :'taker_visit', :'second', 'Peg 1', 'hair rig', 'boilie', 6, 2, 2, 2, 2);
...
select public.record_catch(test.player(183), :'third_visit', :'third', 'Peg 1', 'hair rig', 'boilie', 6, 2, 2, 2, 2) as third_catch \gset
select test.assert_that(
...
select public.record_catch(test.player(183), :'third_visit', :'tiddler', 'Peg 1', 'hair rig', 'boilie', 6, 2, 2, 2, 2);
select test.assert_that(
